...
export const score = (x, y) => {
  const landingRingRadius = Math.sqrt(x ** 2 + y ** 2)

  if (landingRingRadius <= 1) return 10
  if (landingRingRadius <= 5) return 5
  if (landingRingRadius <= 10) return 1
  if (landingRingRadius > 10) return 0
}
